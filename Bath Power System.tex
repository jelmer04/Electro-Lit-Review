\subsection{Voltage Measurement}\label{Voltage-Measurement}
...
The most basic form of current measurement can be undertaken using a sub-ohm resistor of known value. The resistor is wired in series with the circuit under test, and the voltage drop measured using one of the techniques discussed in \ref{Voltage-Measurement}. Using Ohm's Law \cite{ohms-law} $V = I \times R$
