...
The most basic form of current measurement can be undertaken using a sub-ohm resistor of known value. The resistor is placed in series with the circuit under test, and the voltage drop across it is measured using one of the techniques discussed in \ref{volt-meas}.
